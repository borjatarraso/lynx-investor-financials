...
class ReportView(VerticalScroll):
    ...
    def add_stage(self, stage: str, report: AnalysisReport) -> None:
        ...
        if stage == "profile":
            ...
            self._mount_section("Tech Quality", _build_finance_quality(report))
...
class LynxFinanceApp(PagingAppMixin, App):
        ...
        if isinstance(focused, DataTable):
            ...
            if section == "conclusion":
                ...
                try:
                    ...
                    for cat in ("valuation", "profitability", "solvency", "growth", "finance_quality"):
    ...
    def action_cycle_theme(self) -> None:
        from lynx_finance.tui.themes import THEME_NAMES
    ...
    def action__ee_lynx(self) -> None:
        from lynx_finance.easter import LYNX_ASCII, WOLF_ASCII, BULL_ASCII
        import random
...
def _build_profile_table(r: AnalysisReport) -> DataTable:
    ...
    _r2(t, "Tech Category", _s(p.finance_category.value if hasattr(p.finance_category, "value") else p.finance_category))
...
def _build_finance_quality(r: AnalysisReport) -> Static:
    ...
    def rel(key: str) -> Relevance:
        return _get_rel(key, tier, "finance_quality", stage)
